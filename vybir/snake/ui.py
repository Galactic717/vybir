...
def compose(game, decision, stats):
    ...
    c.put(1, left, "VYBIR  /  LOCAL INTELLIGENCE", MUTED)
    ...
    c.put(4, right, "Vybir", GREEN)
    c.put(5, right, f"{stats.get('hardware', 'Windows x64')} · Local", MUTED)
    ...
    c.put(26, right + 18, stats.get("engine", "TORCH · FP32"), MUTED)
