...
from vybir.snake.game import DIRECTIONS, SnakeGame, hamiltonian_cycle
from vybir.snake.policy import LayaPolicy, local_checkpoint
...
def test_recording_rejects_invalid_wall_clock_timestamps(tmp_path, times):
    from vybir.snake.replay import load_record
