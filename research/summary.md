...
| sms_scam | laya-zero-shot | 0 | 0.05 (per class) | 0.954 | 60.9% | 4.56% ± 0.33% | 8/20 |
...
| sms_scam | vybir-adapter | 64 | 0.05 (per class) | 0.952 | 58.9% | 4.82% ± 0.39% | 10/20 |
...
| sms_scam | vybir-adapter | 3144 | 0.05 (per class) | 0.951 | 70.1% | 4.86% ± 0.24% | 11/20 |
...
| sms_scam | tfidf-yardstick | 3144 | 0.05 (per class) | 0.955 | 96.1% | 3.00% ± 0.27% | 1/20 |
...
| prompt_injection | laya-zero-shot | 0 | 0.05 (per class) | 0.953 | 42.6% | 4.66% ± 0.48% | 8/20 |
...
| prompt_injection | vybir-adapter | 64 | 0.05 (per class) | 0.957 | 42.8% | 4.32% ± 0.44% | 8/20 |
...
| prompt_injection | vybir-adapter | 197 | 0.05 (per class) | 0.956 | 45.7% | 4.43% ± 0.44% | 7/20 |
...
| prompt_injection | tfidf-yardstick | 197 | 0.05 (per class) | 0.957 | 59.5% | 4.32% ± 0.31% | 5/20 |
...
| jailbreak | laya-zero-shot | 0 | 0.05 (per class) | 0.956 | 100.0% | 1.25% ± 0.08% | 0/20 |
...
| jailbreak | vybir-adapter | 64 | 0.05 (per class) | 0.960 | 100.0% | 0.84% ± 0.11% | 0/20 |
...
| jailbreak | vybir-adapter | 584 | 0.05 (per class) | 0.956 | 100.0% | 0.56% ± 0.06% | 0/20 |
...
| jailbreak | tfidf-yardstick | 584 | 0.05 (per class) | 0.956 | 98.2% | 3.88% ± 0.21% | 2/20 |